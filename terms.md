...
---
## CMDB
- aliases:: Configuration Management Database; база данных управления конфигурацией
- mean:: централизованное хранилище сведений о компонентах ИТ‑инфраструктуры (Configuration Items, CI) и связях между ними; обычно там есть записи о серверах, ПО, сетевых устройствах, сервисах, плюс атрибуты и история изменений.

---
## SLO 
- aliases:: Service Level Objective; цель по уровню обслуживания
- mean:: внутренняя цель, которую вы ставите перед собой, чтобы обеспечить соответствие ваших услуг ожиданиям клиентов; эти ожидания фиксируются в соглашениях об уровнях обслуживания (SLA) между вами и клиентом.


---
## SLA
- aliases:: Service Level Agreement; соглашение об уровне обслуживания
- mean:: соглашение между поставщиком и клиентом, в котором оговариваются измеряемые показатели, например время безотказной работы или время реагирования, а также конкретные меры ответственности.

---
## SLI
- aliases:: Service Level Indicator; индикатор уровня обслуживания
- mean:: фактическая измеримая метрика, по которой проверяют, выполняется ли SLO

---
## [[Agile]]
- aliases:: Аджайл
- mean:: подход, согласно которому работу разбивают на этапы, с упором на непрерывную поставку и совершенствование.

---
## [[Waterfall]]
- aliases:: водопадная модель
- mean:: линейный, последовательный подход к управлению проектами, имеющий четко выраженные фазы и строгую последовательность.
